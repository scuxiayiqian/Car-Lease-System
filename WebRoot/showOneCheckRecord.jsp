...
<html lang="zh">
	...
	<body>
	<%
		CheckTableVo oneCheckRecord = (CheckTableVo)request.getAttribute("oneCheckRecord");
	...
	<div id="header"><div align="left"> 
		...
		<div id="breadcrumb">
				...
				<a href="ShowAllCheckRecordServlet" class="tip-bottom">检查单管理</a>
				<a href="#" title="当前页" class="current">查看检查单</a>
		</div>
			...
			<table class="table table-hover table-bordered">
				...
				<tbody>
					<tr>
						...
						<td>
							<%out.print(oneCheckRecord.getId()); %>
						</td>
					</tr>
					<tr class="success">
						<td>
						...
						<td>
							<%out.print(oneCheckRecord.getCheckid()); %>
						</td>
					</tr>
					<tr class="error">
						<td>
						...
						<td>
							<%out.print(oneCheckRecord.getCheckdate().toString()); %>
						</td>
					</tr>
					<tr class="warning">
						<td>
						...
						<td>
							<%out.print(oneCheckRecord.getField()); %>
						</td>	
					</tr>
					<tr class="info">
						<td>
						...
						<td>
							<%out.print(oneCheckRecord.getProblem()); %>
						</td>
					</tr>
					<tr>
						<td>
						...
						<td>
							<%out.print(oneCheckRecord.getPaying()); %>
						</td>
					</tr>
					<tr class="success">
						<td>
						...
						<td>
							<%out.print(oneCheckRecord.getCheckuserid()); %>
						</td>
					</tr>
					<tr class="error">
						<td>
						...
						<td>
							<%out.print(oneCheckRecord.getRentid()); %>
						</td>
					</tr>
