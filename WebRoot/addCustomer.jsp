...
<head>
	...
	<body>
	<div id="header">
			<h1><a href="./dashboard.html">牵君GO汽车租赁系统</a></h1>		
		</div>
		...
		<div id="sidebar">
			...
			<ul>
				...
				<li class="submenu active open">
					...
					<ul>
						<li class="active"><a href="addCustomer.jsp">添加客户信息</a></li>
		...
		<div id="breadcrumb">
				...
				<a href="#" class="tip-bottom">客户管理</a>
				<a href="addCustomer.jsp" title="当前页" class="current">添加客户信息</a>
		</div>
					...
					<div class="span12">
						<div class="widget-box">
							...
							<div class="widget-content nopadding">
								<form name="form" action="<%=basePath%>AddCustomersServlet" method="post" class="form-horizontal" />
									...
									<div class="control-group">
										<label class="control-label">客户密码</label>
										<div class="controls">
