...
<html lang="zh">
	...
	<div id="header"><div align="left"> 
		...
		<div class="row-fluid">
			<form name="form" action="<%=basePath%>UpdateOneUserFromJspServlet" method="post" class="form-horizontal" />
				<div class="row-fluid">
					<div class="span12">
					...
					<tr>
						...
						<td>
							<input type="text" readonly="true" name="id" id="id" value="<%out.print(uservo.getId()); %>"/>	
						</td>
					</tr>
					<tr class="success">
						<td>
						...
						<td>
							<input type="text" name="fullname" id="fullname" value="<%out.print(uservo.getFullname()); %>"/>	
						</td>
					</tr>
					<tr class="error">
						<td>
						...
						<td>
							<input type="text" name="position" id="position" value="<%out.print(uservo.getPosition()); %>"/>	
						</td>
					</tr>
					<tr class="warning">
						<td>
						...
						<td>
							<input type="text" name="phone" id="phone" value="<%out.print(uservo.getPhone()); %>"/>	
						</td>	
					</tr>
					<tr class="info">
						<td>
						...
						<td>
							<input type="text" name="address" id="address" value="<%out.print(uservo.getAddress()); %>"/>	
						</td>
					</tr>
					<tr>
						<td>
					...
					<tr class="success">
						...
						<td>
							<input type="text" name="identity" id="identity" value="<%out.print(uservo.getIdentity()); %>"/>	
						</td>
					</tr>
					<tr class="error">
						<td>
						...
						<td>
							<input type="text" name="username" id="username" value="<%out.print(uservo.getUsername()); %>"/>	
						</td>
					</tr>
					<tr class="warning">
						<td>
						...
						<td>
							<input type="text" readonly="true" name="userlevel" id="userlevel" value="<%out.print("用户"); %>"/>	
						</td>
					</tr>
