	...
	<div id="header">
		...
		<div id="sidebar">
			...
			<ul>
				...
				<li class="submenu">
					<a href="addUser.html"><i class="icon icon-th-list"></i> <span>用户管理</span> <span class="label">2</span></a>
					<ul>
		...
		<div id="breadcrumb">
				...
				<a href="ShowAllCustomerServlet" title="当前页" class="current">查询客户信息</a>
		</div>
								...
								<table class="table table-bordered data-table">
									...
									for(i=0;i<list.size();i++)
									{
										out.println("<tr class=\"gradeX\">");
											...
											out.println("<td><a href=\"ShowOneCustomerServlet?id="+list.get(i).getId()+"\" title=\"查看客户\" class=\"btn btn-success \">查看</a> <a href=\"UpdateOneCustomerServlet?id="+list.get(i).getId()+"\" title=\"修改客户\" class=\"btn btn-primary \">修改</a> <a href=\"DeleteOneCustomerServlet?id="+list.get(i).getId()+"\" title=\"删除客户\" class=\"btn btn-danger \">删除</a></td>");
										out.println("</tr>");
									}								
									 %>
									</tbody>
