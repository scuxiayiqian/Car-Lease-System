				...
				<div class="row-fluid">
					<div class="span12">
						...
						<div class="alert alert-success">
							...
							<strong>查询成功！</strong> 以下是客户：<strong><%out.print(identity); %></strong>的租车情况
						</div>
					</div>
				</div>
								...
								<table class="table table-bordered data-table">
									...
									for(i=0;i<rentList.size();i++)
									{
										out.println("<tr class=\"gradeX\">");
											...
											out.println("<td><a href=\"ReturnCarServlet?id="+rentList.get(i).getId()+"\" title=\"归还入库\" class=\"btn btn-success \">归还入库</a> <a href=\"AddCheckRecordServlet?id="+rentList.get(i).getId()+"\" title=\"汽车报修\" class=\"btn btn-danger \">汽车报修</a></td>");
