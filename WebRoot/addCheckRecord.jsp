...
<html lang="zh">
	...
	//	RentTablesVo rentRecord = (RentTablesVo)request.getAttribute("rentRecord");
		int rentid = (Integer)request.getAttribute("rentid");
	...
	<div id="header"><div align="left"> 
		...
		<div id="breadcrumb">
				...
				<a href="ShowAllRentRecordServlet" class="tip-bottom">业务管理</a>
		...
		<div class="row-fluid">
			<form name="form" action="<%=basePath%>AddCheckRecordFromJspServlet" method="post" class="form-horizontal" />
				<div class="row-fluid">
					<div class="span12">
					...
					<tr>
						...
						<td>
							<input type="text" readonly="true" name="rentid" id="rentid" value="<%out.print(rentid); %>"/>	
						</td>
					</tr>
					<tr class="success">
						<td>
						...
						<td>
							<input type="text" name="checkdate" id="checkdate" data-date="2013-12-01" data-date-format="yyyy-mm-dd" class="datepicker" value="<%out.print(today.toString()); %>"/>	
						</td>
					</tr>
					<tr class="error">
						<td>
					...
					<tr class="warning">
						...
						<td>
							<input type="text" name="paying" id="paying" />	
						</td>	
					</tr>
					<tr class="info">
						<td>
						...
						<td>
							<input type="text" name="checkuserid" id="checkuserid" />	
						</td>
					</tr>
				</tbody>
			 </table>
			...
			<div class="form-actions">
				<button type="submit" data-loading-text="正在提交..." class="btn btn-success btn-large">&nbsp;&nbsp;报修 &nbsp;&nbsp;</button>
			</div>			
		</form>
