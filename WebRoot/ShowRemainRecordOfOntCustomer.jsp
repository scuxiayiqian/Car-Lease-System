				...
				<div class="row-fluid">
					<div class="span12">
						...
						<div class="alert alert-success">
							...
							<strong>归还成功！</strong> 以下是客户：<strong><%out.print(identity); %></strong>的剩余租车列表
						</div>
					</div>
				</div>
								...
								<table class="table table-bordered data-table">
									...
									for(i=0;i<rentList.size();i++)
									{
										out.println("<tr class=\"gradeX\">");
											...
											out.println("<td><a href=\"ReturnCarServlet?id="+rentList.get(i).getId()+"\" title=\"归还入库\" class=\"btn btn-warning \">归还入库</a></td>");								
										out.println("</tr>");
									}
