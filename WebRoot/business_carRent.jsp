...
<body>
	<%	int cusrid = (Integer)request.getAttribute("cusrid");
		int carid = (Integer)request.getAttribute("id");
		double rentprice = (Double)request.getAttribute("rentprice");
					...
					<div class="span12">
						<div class="widget-box">
							...
							<div class="widget-content nopadding">
								<form class="form-horizontal" method="post" action="<%=basePath%>RentCarServlet" name="number_validate" id="number_validate" novalidate="novalidate" />
									
									<div class="control-group">
										<label class="control-label">客户编号</label>
										<div class="controls">
											<input type="text" name="cusrid" id="cusrid" value="<%out.print(cusrid); %>" />
										</div>
									</div>
									
									<div class="control-group">
										<label class="control-label">汽车编号</label>
										<div class="controls">
											<input type="text" name="carsid" id="carsid" value="<%out.print(carid); %>" />
										</div>
									</div>
									
									<div class="control-group">
										<label class="control-label">预付金额(即租金)</label>
										<div class="controls">
											<input type="text" name="imprest" id="imprest" value="<%out.print(rentprice); %>" />
										</div>
									</div>
									
									<div class="control-group">
										<label class="control-label">应付金额(即租金加押金)</label>
										<div class="controls">
											<input type="text" name="shouldpayprice" id="shouldpayprice" value="<%out.print(rentprice + deposit); %>" />
										</div>
									</div>
									
									<div class="control-group">
										<label class="control-label">实际交付金额</label>
										<div class="controls">
									...
									<div class="control-group">
                                        <label class="control-label">起租日期</label>
                                        <div class="controls">
                                            <input type="text" name="begindate" data-date="2013-12-01" data-date-format="yyyy-mm-dd" class="datepicker" />
                                        </div>
                                    </div>
									
									<div class="control-group">
                                        <label class="control-label">应归还日期</label>
                                        <div class="controls">
                                            <input type="text" name="shouldretumdate" data-date="2013-12-01" data-date-format="yyyy-mm-dd" class="datepicker" />
                                        </div>
                                    </div>
                                    
                            		<div class="control-group">
										<label class="control-label">请正在进行汽车出租的服务人员输入编号</label>
										<div class="controls">
