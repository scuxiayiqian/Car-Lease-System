<%@ page language="java" import="java.util.*,scu.sw.business.RentTablesVo" contentType="text/html; charset=gb2312"
    pageEncoding="gb2312"%>
<%@page import="scu.sw.business.RentTablesVo"%>
...
<html lang="zh">
	...
	<div id="header"><div align="left"> 
		...
		<div id="sidebar">
			...
			<ul>
				...
				<li class="submenu active open">
					...
					<ul>
						<li class="active"><a href="SearchReturnWithinOneMonthServlet">当月应还汽车</a></li>
					</ul>
				</li>
			</ul>
		</div>
		...
		<div id="breadcrumb">
				...
				<a href="SearchReturnWithinOneMonthServlet" class="tip-bottom">业务统计</a>
				<a href="SearchReturnWithinOneMonthServlet" title="当前页" class="current">当月应还汽车</a>
		</div>
								...
								<table class="table table-bordered data-table">
									...
									for(i=0;i<rentList.size();i++)
									{
										out.println("<tr class=\"gradeX\">");
											...
											out.println("<td>" + rentList.get(i).getBegindate().toString() + "</td>");
											out.println("<td>" + rentList.get(i).getShouldretumdate().toString() + "</td>");
											...
											out.println("<td><a href=\"ShowRentTableServlet2?id="+rentList.get(i).getId()+"\" title=\"查看出租单\" class=\"btn btn-success \">查看</a></td>");			
										out.println("</tr>");
									}
