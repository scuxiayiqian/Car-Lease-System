...
public class DeleteOneCustomerServlet extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		ShowOneCustomer showOneUser = new ShowOneCustomer();
		customersVo vo = showOneUser.showOneCustomer(id);

		request.setAttribute("vo", vo);
		request.getRequestDispatcher("deleteOneCustomerEnsure.jsp").forward(
